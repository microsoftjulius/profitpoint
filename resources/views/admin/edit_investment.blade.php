                        ...
                        <div class="row">
                            <div class="contentpanel contentpanel-wizard">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <!-- BASIC WIZARD -->
                                        <form method="get" id="basicWizard" class="panel-wizard" action="/update-investment/{{request()->route()->investment_id}}">
                                            
                                                    @foreach($investment as $inve)
                                                        <label class="col-sm-4">Amount</label>
                                                        <div class="col-sm-8">
                                                            @if(auth()->user()->currency == "/=")
                                                            <input type="number" name="investment_edit" class="form-control" value="{{ $inve->amount }}"/>
                                                            @else
                                                            <input type="number" name="investment_edit" class="form-control" value="{{ round($inve->amount / 3700,0) }}"/>
                                                            @endif
                                                        </div>
                                                    @endforeach
                                                    </div><!-- form-group -->
